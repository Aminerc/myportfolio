...
const experiences: TExperience[] = [
  ...
  },
  {
    ...
    points: [
      "Comptabilité française : principes, normes, réglementations et obligations comptables. ",
...
const projects: TProject[] = [
  ...
  },
  {
    ...
    description:
      `Rapport PowerBi pour suivre les performances d'un Call Center subdivisé en 3 catégories : performances générales, performanes des employés et performances des managers.
